  ...
  return (
    ...
    <div className={styles.rootDiv}>
      <div className={styles.contentDiv}>
        ...
        <p className={styles.homeDescription}>Me, <span className={`${styles.fontGreen} ${styles.standOutFont}`}>ROHITH REDDY</span> currently working as a Software Engineer.</p>
      </div>
